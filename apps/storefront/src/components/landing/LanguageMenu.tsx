  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        aria-expanded={open}
        aria-label={title}
        className={`inline-flex items-center gap-1 h-9 rounded-lg border pl-3 pr-2 text-sm font-semibold uppercase transition-all duration-200 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${
          open
            ? "border-emerald-500 text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40"
            : "border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:border-emerald-500 hover:text-emerald-700 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/40"
        }`}
      >
        {locale}
        <ChevronDownIcon
            ...
            {LANGUAGES.map((l) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 rounded-xl border-2 px-3 py-2.5 text-left text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${
                    selected
                      ? "border-emerald-600 dark:border-emerald-500 bg-emerald-50/60 dark:bg-emerald-950/30"
                ...
                >
                  ...
                  >
                    {selected && <span className="w-2 h-2 rounded-full bg-emerald-600 dark:bg-emerald-500" />}
                  </span>
                  <Flag width={26} />
                  <span>{l.label}</span>
                </button>
